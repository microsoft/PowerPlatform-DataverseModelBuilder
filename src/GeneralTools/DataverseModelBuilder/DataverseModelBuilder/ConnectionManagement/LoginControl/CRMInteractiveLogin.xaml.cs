...
namespace Microsoft.PowerPlatform.Dataverse.DataverseModelBuilder.ConnectionManagement.LoginControl
{
    /// <summary>
    /// Interaction logic for DvInteractiveLogin.xaml
    /// </summary>
    public partial class DvInteractiveLogin : Window
    {
        #region Vars
        /// <summary>
        ...
        /// </summary>
        internal CrmConnectionManager CrmConnectionMgr { get { return mgr; } }
        ...
        public DvInteractiveLogin()
        {
            ...
            //    return true;
            //};
            HostApplicatioNameOveride = null;
            HostProfileName = "default";
            ForceDirectLogin = false;
 ...
 */
            ...
            //// OAuth Enablement added for CRM 8.0 +
            ...
            mgr.HostApplicatioNameOveride = HostApplicatioNameOveride;
            mgr.ProfileName = HostProfileName;
        ...
        private void mgr_ConnectionCheckComplete(object sender, ServerConnectStatusEventArgs e)
        {
            ...
            if (!e.Connected)
            {
                ...
                if (e.MultiOrgsFound)
                    MessageBox.Show("Unable to Login to Dataverse using cached credentials. Org Not found", "Login Failure");
                else
                    MessageBox.Show("Unable to Login to Dataverse using cached credentials", "Login Failure");
                ...
                Dispatcher.Invoke(DispatcherPriority.Normal,
                       new System.Action(() =>
                       {
                           ...
                           MessageBox.Show(this.Title, "Notification from Dataverse ConnectionManager", MessageBoxButton.OK, MessageBoxImage.Error);
