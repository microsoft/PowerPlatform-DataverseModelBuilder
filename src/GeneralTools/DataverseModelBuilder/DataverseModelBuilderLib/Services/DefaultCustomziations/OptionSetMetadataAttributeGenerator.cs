...
{
    internal class OptionSetMetadataAttributeGenerator
    {

        #region CreateOptionSetAttribute
        internal static CodeAttributeDeclaration CreateOptionSetAttribute(string optionName, OptionMetadata option)
        {
            return new CodeAttributeDeclaration("OptionSetMetadataAttribute",
                    new CodeAttributeArgument(new CodePrimitiveExpression(optionName)),
                    new CodeAttributeArgument(new CodePrimitiveExpression(option.Value)));
        }
        #endregion

        #region OptionSetMetadataAttribute Class Generation

        internal static CodeTypeDeclaration CreateOptionSetMetadataAttributeClass()
        {
        ...
        internal static CodeTypeDeclaration CreateOptionSetExtensionClass()
        {
            var extClass = new CodeTypeDeclaration("OptionSetExtension")
            {
                IsClass = true,
                Attributes = CodeDomMemberAttributes.Static
            };
